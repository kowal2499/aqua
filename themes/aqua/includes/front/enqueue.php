...
//	wp_register_style('aqua_bootstrap',
//			get_template_directory_uri() . '/assets/styles/bootstrap.min.css');

	wp_register_style('aqua_main', get_template_directory_uri() . '/assets/build/style.css', $ver='2.0');
	
//	wp_register_style('aqua_owl.carousel',
//			get_template_directory_uri() . '/assets/styles/owl.carousel.min.css');
	
//	wp_register_style('aqua_owl.theme',
//			get_template_directory_uri() . '/assets/styles/owl.theme.default.min.css');

//	wp_register_style('aqua_lightbox',
//			get_template_directory_uri() . '/assets/styles/simplelightbox.min.css');
	...
	wp_enqueue_style('aqua_owl.carousel');
	wp_enqueue_style('aqua_lightbox');
	wp_enqueue_style('aqua_owl.theme');
